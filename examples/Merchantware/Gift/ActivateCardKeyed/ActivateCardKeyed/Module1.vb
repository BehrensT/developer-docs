Imports ActivateCardKeyed.MWGift45
Module Module1
    Sub Main()
        'Create Soap Client
        ...
        Dim activateCardRequest As New ActivateCardRequest With {
            .Amount = "10.00",
        ...
        giftResponse45 = giftSoapClient.ActivateCard(merchantCredentials, giftPaymentData, activateCardRequest)
        'Display Results
